...
def main():
    ...
    p = {
        ...
        'data_path': os.path.join("btcusdt_options_call_V2", "real_btcusdt_implied_params_mlp", "run_4", "btc_option_parameters_160.csv")
    }
    ...
    # Normalization สำหรับ Input 6 ตัว
    ...
    # แปลงเป็น array 1 มิติ และคำนวณค่า RMSE และ Correlation
    ...
    # สร้าง Title พร้อมแสดงค่า RMSE และ Correlation (R)
    title_str = (
        f"Market vs. PINN Price Comparison\n"
        f"(RMSE: {rmse:.2f}, R: {correlation:.4f})"
    )
    ...
    # พล็อตกราฟเส้นตามสไตล์ของรูปภาพตัวอย่าง
    ...
    # รวม legend จากทั้งสองแกนมาแสดงผลที่เดียว
    lines1, labels1 = ax1.get_legend_handles_labels()
    lines2, labels2 = ax2.get_legend_handles_labels()
    ax1.legend(lines1 + lines2, labels1 + labels2, loc='upper right')

    plt.tight_layout(rect=[0, 0.03, 1, 0.95])
    # บันทึกกราฟเป็นไฟล์ใหม่
    ...
    # กราฟแท่งเทียนพร้อมเส้น Prediction และส่งค่า metrics เข้าไป
